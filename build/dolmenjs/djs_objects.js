...
export class djs_objects {
    constructor() {
        ...
        this.grid_count = 0;
        this.grid = (dom_parent, json_parameter) => {
            class c_grid {
                constructor(dom_parent, json_parameter) {
                    this.cols = [];
                    this.rows = [];
                    this.col = (n_col) => {
                    ...
                    dom_parent = dom_parent !== null && dom_parent !== void 0 ? dom_parent : document.body;
                    ...
                    if (json_parameter.columns) {
                        ...
                        json_parameter.columns.forEach((width, index) => {
                        ...
                        json_parameter.rows.forEach((height, index) => {
        ...
        this.link = (dom_parent, json_parameter) => {
            class c_link {
                constructor(dom_parent, json_parameter) {
                    dom_parent = dom_parent !== null && dom_parent !== void 0 ? dom_parent : document.body;
        ...
        this.element = (dom_parent, elementName, json_parameter) => {
            class c_element {
                constructor(dom_parent, elementName, json_parameter) {
                    dom_parent = dom_parent !== null && dom_parent !== void 0 ? dom_parent : document.body;
                    json_parameter = json_parameter !== null && json_parameter !== void 0 ? json_parameter : {};
        ...
        this.scroll = (dom_parent, json_parameter) => {
            class c_scroll {
                constructor(dom_parent, json_parameter) {
                    dom_parent = dom_parent !== null && dom_parent !== void 0 ? dom_parent : document.body;
